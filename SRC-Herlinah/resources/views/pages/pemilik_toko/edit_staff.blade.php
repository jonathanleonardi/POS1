        ...
        <div class="modal-body">
            <form>
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control" id="inputIDStaff" value="{{$staff->kode_user}}" readonly required>
                        <input type="hidden" value="{{$staff->id_user}}" name="idStaff" required>
                    </div>
                </div>
                ...
                <div class="form-group row mt-3">
                    ...
                    <div class="col-sm-9">
                        <input type="email" class="form-control" id="inputEmailStaff" maxlength="260" value="{{$staff->email}}" name="emailStaff" readonly required>
                    </div>
                </div>
            </form>
        </div>
