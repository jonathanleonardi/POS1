...
<div class="content d-flex align-items-center flex-column">
    @csrf
    <h2 class="mb-3 mt-5"><strong>Laporan Penjualan</strong></h2>
    <div class="transaction w-75">
        <div class="d-flex justify-content-between">
            <div id="reportrange" class="btn btn-secondary bg-light text-dark">
                <span></span>
            </div>
            <a href="#" class="btn btn-primary" id="printReport"><i class="fa fa-print"></i> Cetak</a>
        </div>
                        ...
                        <td align="center">
                            <span class="d-flex justify-content-center">
                                ...
                                @else
                                    ...
                                    {{-- <form action="/transaksi/delete/{{$item->id_transaksi}}" method="post" id="deleteBarang" class="ml-2"> --}}
                                        @csrf
...
<script>
    ...
    $(document).ready(function() {
        ...
        function cb(start, end) {
            ...
            $('#printReport').attr('href', '/report/'+start.format('YYYY-MM-DD')+'/'+end.format('YYYY-MM-DD'));
        }
        ...
        // $('#printReport').on('click', function(arams) {
        //     var href = $(this).attr('href');
        //     console.log(href);

        //     if(isNaN(href)) {
        //         alert('Pilih rentang tanggal laporan')
        //     }
        // })
