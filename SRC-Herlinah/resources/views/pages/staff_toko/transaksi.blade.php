        ...
        <div class="col-lg-3">
            <div class="card p-3">
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control" id="date" name="tanggal" value="{{ date('Y-m-d h:i:s') }}" autocomplete="off" readonly>
                    </div>
                </div>
                <div class="form-group row pt-3">
                    <label for="date" class="col-sm-3 col-form-label">Kasir</label>
                    <div class="col">
                        <input type="text" class="form-control" name="kasir" value="{{session('user')->nama}}" readonly>
                        <input type="hidden" id="idUser" name="id_user" value="{{ session('user')->id_user }}">
                    </div>
                </div>
            </div>
        </div>
        <div class="col-lg-5">
            <div class="card p-3">
                <div class="form-group row">
                    ...
                    <div class="col-2">
                        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#pilihBarang">Pilih<i class="fa fa-search"></i></button>
                    </div>
                </div>
                <div class="form-group row pt-3">
                    <div class="col-sm-3">
                    ...
                    <!-- <div class="col-2">
                        <button type="button" id="updateCart" class="btn btn-primary"><i class="fa fa-sharp fa-solid fa-plus-circle"></i> Update Test</button>
                    </div> -->
                </div>
            </div>
        </div>
        <div class="col-lg-4">
            <div class="card p-3" style="margin: auto">
                <div style="text-align: right !important">
                    ...
                    <h1><strong id="totalBayar">Rp. 0,00</strong></h1>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="col-lg-1">
            <div class="form-group">
                <select name="jenis_bayar" id="jenisBayar" class="form-control">
                    <option value="" selected hidden>Pembayaran</option>
...
<div class="container-fluid mt-5">
    <div class="row justify-content-between">
        <div class="col">
            <a href="/transaksi" class="btn btn-default btn-outline-secondary" id="baru"><i class="fa fa-plus"></i> Transaksi baru</a>
            <a href="/staffToko" class="btn btn-default btn-outline-secondary" id="baru"><i class="fa fa-list"></i> Daftar transaksi</a>
        </div>
        <div class="col">
...
<script>
    ...
    $((function() {
        ...
        $('#save').on('click', function() {
            ...
            if ($('#bayar').val() < _totalBayar && $('#jenisBayar').val() == 1) {
    ...
    function updateCart() {
        ...
        $.each(_cart, function(i) {
            _html += '<tr>' +
                ...
                '<td class="text-center"><button type="button" class="btn btn-danger" onclick="deleteCart(this, ' + i + ')"><i class="fa fa-trash"></i></button></td>' +
                '</tr>';
    ...
    function deleteCart($this, index = 0, total = 0) {
